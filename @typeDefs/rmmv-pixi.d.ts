...
declare var Decrypter: DecrypterStatic;declare namespace RPG {
     ...
     */
    interface Event extends MetaData {
        /**
         * The event ID.
         */
        id: number;
     ...
     */
    interface Actor extends MetaData {
        /**
         * The ID.
         */
        id: number;
     ...
     */
    interface Class extends MetaData {
        /**
         * The ID.
         */
        id: number;
    ...
    namespace Class {
         ...
         */
        interface Learning extends MetaData {
            /**
             * The data class for a class's [Skills to Learn].
             */
            level: number;
     ...
     */
    interface BaseItem extends MetaData {
        /**
         * The item ID.
         */
        id: number;
    ...
    interface UsableItem extends BaseItem {
        /**
    ...
    interface Skill extends UsableItem {
        /**
         * Skill type ID.
         */
        stypeId: number;
     ...
     */
    interface Item extends UsableItem {
        /**
         * The item type ID.
         *
         * 1: Regular item
     ...
     */
    interface Armor extends EquipItem {
        /**
         * The armor type ID.
         */
        atypeId: number;
     ...
     */
    interface Enemy extends MetaData {
        /**
     ...
     */
    interface Tileset extends MetaData {
        /**
...
declare class Window_Command extends Window_Selectable {
   ...
   * @memberof Window_Command
   */
  addCommand(name: string, symbol: string, enabled: boolean, ext?: any | object): void;
  /**
